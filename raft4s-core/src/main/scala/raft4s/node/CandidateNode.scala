...
case class CandidateNode(nodeId: String, nodes: List[String], currentTerm: Long, lastTerm: Long, votedFor: Option[String], votedReceived: Set[String]) extends NodeState {
